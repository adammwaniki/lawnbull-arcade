          ...
          <nav>
            <ul className="space-y-2">
              {['Home', 'About', 'Marketing', 'Login'].map((item, index) => (
                <li
                  key={item}
                  className={`bg-gradient-to-r from-indigo-500/80 from-10% via-sky-500/80 via-30% to-emerald-500/80 to-90% rounded-full transition-all duration-500 ease-out transform ${
